        ...
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-6 max-w-md text-center leading-relaxed text-foreground-500 sm:max-w-xs sm:text-left">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-primary">About Us</p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <Link
                      ...
                      href="#"
                    >
                      <span className="text-foreground-700 transition group-hover:text-foreground-700/75">
                        Live Chat
                      </span>
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-primary">Contact Us</p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="size-5 shrink-0 text-foreground-900"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                      ...
                      <span className="flex-1 text-foreground-700">john@doe.com</span>
                    </Link>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-foreground-700">0123456789</span>
                    </Link>
                  </li>
                  ...
                  <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    ...
                    <address className="-mt-0.5 flex-1 text-foreground-700 not-italic">
          ...
          <div className="mt-12 border-t border-foreground-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p className="mt-4 text-sm text-foreground-500 sm:order-first sm:mt-0">
