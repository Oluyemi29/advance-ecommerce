...
const LatestProduct = ({ products }: ProductProps) => {
  const ProductNeeded = products.slice(0, 4);
  ...
  return (
    ...
    >
      <div className="text-center text-3xl">
        <span className="text-primary text-5xl font-semibold ml-2">O</span>ur
        <span className="text-primary text-5xl font-semibold ml-2">L</span>atest
      ...
      <div className="w-[70%] mx-auto grid place-content-center lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
        {ProductNeeded.map((product, index) => {
